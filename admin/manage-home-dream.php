...
$queryResult=Dreams::getAllCategoryInfo();

if(isset($_GET['status'])) {
    $id=$_GET['id'];
    if ($_GET['status']=='unpublished') {
        Dreams::unpublishedCategoryInfo($id);
    }else if($_GET['status']=='published'){
        Dreams::publishedCategoryInfo($id);
    }
...
if (isset($_GET['p'])) {
    $id = $_GET['id'];
    Dreams::deleteCategoryInfoById($id);
}
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="add-home-dream.php">Add Home Dream<span class="sr-only">(current)</span></a></li>
                <li><a href="manage-home-dream.php">Manage Home Dream</a></li>
            </ul>
                        ...
                        while($row=mysqli_fetch_assoc($queryResult)) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <a href="edit-home-dream.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-xs" title="Edit Blog">
