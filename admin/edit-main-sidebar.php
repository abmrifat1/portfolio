...
if(isset($_POST['btn'])){
    $id=$_GET['id'];
    $message=Mainsidebar::updateCategoryInfo($_POST,$id);
}

$id=$_GET['id'];
$queryResult1=Mainsidebar:: getCategoryInfoById($id);
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="../admin/add-main-sidebar.php">Add Main Sidebar<span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="../admin/manage-main-sidebar.php">Manage Main Sidebar<span class="sr-only">(current)</span></a></li>
            </ul>
            ...
            <div class="well">
                ...
                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="category_title" value="<?php echo $categoryInfo['category_title'];?>" class="form-control" id="inputEmail3" placeholder="Category Title">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input  name="image_url" type="hidden" value="<?php echo $categoryInfo['category_image'];?>">

                            <img src="<?php echo $categoryInfo['category_image'];?>" height="80px" width="80px"/>
                        </div>
                    </div>
                    <div class="form-group">
