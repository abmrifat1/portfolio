...
$queryResult=Mainsidebar::getAllCategoryInfo();

if(isset($_GET['status'])) {
    $id=$_GET['id'];
    if ($_GET['status']=='unpublished') {
        Mainsidebar::unpublishedCategoryInfo($id);
    }else if($_GET['status']=='published'){
        Mainsidebar::publishedCategoryInfo($id);
    }
...
if (isset($_GET['p'])) {
    $id = $_GET['id'];
    Mainsidebar::deleteCategoryInfoById($id);
}
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="add-main-sidebar.php">Add Main Sidebar<span class="sr-only">(current)</span></a></li>
                <li><a href="manage-main-sidebar.php">Manage Main Sidebar</a></li>
            </ul>
                        ...
                        while($row=mysqli_fetch_assoc($queryResult)) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <a href="edit-main-sidebar.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-xs" title="Edit Blog">
