...
if(isset($_POST['btn'])){
    $id=$_GET['id'];
    $message=Gallery::updateCategoryInfo($_POST,$id);
}

$id=$_GET['id'];
$queryResult1=Gallery:: getCategoryInfoById($id);
            ...
            <div class="well">
                ...
                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="category_title" value="<?php echo $categoryInfo['id'];?>" class="form-control" id="inputEmail3" placeholder="Category Title">
                        </div>
                    </div>
