...
$queryResult=Header::getAllCategoryInfo();

if(isset($_GET['status'])) {
    $id=$_GET['id'];
    if ($_GET['status']=='unpublished') {
        Header::unpublishedCategoryInfo($id);
    }else if($_GET['status']=='published'){
        Header::publishedCategoryInfo($id);
    }
...
if (isset($_GET['p'])) {
    $id = $_GET['id'];
    Header::deleteCategoryInfoById($id);
}
                        ...
                        while($row=mysqli_fetch_assoc($queryResult)) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <a href="edit-header.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-xs" title="Edit Blog">
