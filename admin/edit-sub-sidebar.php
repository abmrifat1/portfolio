...
if(isset($_POST['btn'])){
    $id=$_GET['id'];
    $message=Subsidebar::updateCategoryInfo($_POST,$id);
}

$id=$_GET['id'];
$queryResult1=Subsidebar:: getCategoryInfoById($id);
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="../admin/add-sub-sidebar.php">Add Sub Sidebar<span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="../admin/manage-sub-sidebar.php">Manage Sub Sidebar<span class="sr-only">(current)</span></a></li>
            </ul>
                ...
                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="<?php echo $categoryInfo['category_image'];?>" style="height: 80px;width: 80px">
                        </div>
                    </div>
                    <div class="form-group">
